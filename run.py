...
def get_sales_data():
    ...
    which must be 6 numbers separated by commas.
    Loop will repeat until data is valid

    """

    while True:
    
    # Subsequently indented after while loop applied
...
def get_last_5_entries_sales():
    ...
    for ind in range(1, 7):
        ...
        #[-5:] is a slice function to pick out last 5 rows in columns
